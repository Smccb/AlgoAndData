...
public class MainOld {
	...
	static StackReferenceBased SRB = new StackReferenceBased();
	...
	public static void createTree(ArrayList <TreeNode> tn) {
	   ...
	   while(tn.size() > 0) {
		   int childNode1 = tn.get(i).getFreq();
		   TreeNode cN1 = tn.get(i);
		   tn.remove(i);
		   
		   int childNode2 = tn.get(i).getFreq();
		   TreeNode cN2 = tn.get(i);
		   tn.remove(i);
		   int total = childNode1 + childNode2;
		   
		   SRB.push(total, PARENT_SYMBOL, cN1, cN2);
